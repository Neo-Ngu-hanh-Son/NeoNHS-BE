...
/**
 * Response DTO for points that are displayed on the map, which can represent both events and workshops.
 * This class extends PointResponse to include common point fields, and adds specific fields relevant to events and workshops.
 */
...
public class MapPointResponse extends PointResponse {
    ...
    public static MapPointResponse fromPoint(Point p) {
        return MapPointResponse.builder()
                ...
                .defaultPitch(p.getDefaultPitch())
    ...
    public static MapPointResponse fromEventPoint(Event e) {
        String eventImage = (e.getEventImages() != null && !e.getEventImages().isEmpty()) ? e.getEventImages().get(0).getImageUrl() : null;
