...
public class VendorVoucherController {
    ...
    @Operation(
            summary = "Redeem gift voucher at counter (Vendor)",
            description = "Mark a user's GIFT_PRODUCT voucher as used. Only allowed for vouchers issued by current vendor."
    )
