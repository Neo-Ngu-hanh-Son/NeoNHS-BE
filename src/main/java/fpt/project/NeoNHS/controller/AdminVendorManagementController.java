...
public class AdminVendorManagementController {
        ...
        @Operation(summary = "Hard delete vendor", description = "Completely remove a vendor account from database")
        public ResponseEntity<ApiResponse<Void>> hardDeleteVendor(@PathVariable UUID id) {
                ...
                return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK, "Vendor hard deleted successfully", null));
        }
        ...
        public ResponseEntity<ApiResponse<Page<VendorProfileResponse>>> searchVendors(
                ...
                return ResponseEntity.ok(
                                ApiResponse.success(HttpStatus.OK, "Search results retrieved successfully", vendors));
        }
        ...
        public ResponseEntity<ApiResponse<Page<VendorProfileResponse>>> advancedFilter(
                ...
                return ResponseEntity.ok(
                                ApiResponse.success(HttpStatus.OK, "Filtered results retrieved successfully", vendors));
        }
        ...
        public ResponseEntity<ApiResponse<Page<VendorProfileResponse>>> filterByVerification(
                ...
                Page<VendorProfileResponse> vendors = adminVendorManagementService
                                .filterVendorsByVerification(isVerified, pageable);
                return ResponseEntity.ok(
                                ApiResponse.success(HttpStatus.OK, "Filtered vendors retrieved successfully", vendors));
        }
        ...
        public ResponseEntity<ApiResponse<Page<VendorProfileResponse>>> filterByBannedStatus(
                ...
                Page<VendorProfileResponse> vendors = adminVendorManagementService.filterVendorsByBannedStatus(isBanned,
                                pageable);
                return ResponseEntity.ok(
                                ApiResponse.success(HttpStatus.OK, "Filtered vendors retrieved successfully", vendors));
        }
        ...
        public ResponseEntity<ApiResponse<Page<VendorProfileResponse>>> filterByActiveStatus(
                ...
                Page<VendorProfileResponse> vendors = adminVendorManagementService.filterVendorsByActiveStatus(isActive,
                                pageable);
                return ResponseEntity.ok(
                                ApiResponse.success(HttpStatus.OK, "Filtered vendors retrieved successfully", vendors));
        }
        ...
        @Operation(summary = "Get all workshop templates for a specific vendor (Admin only)", description = """
                        ...
                        **Use Cases:**
                        ...
                        """)
        @ApiResponses(value = {
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Templates retrieved successfully", content = @Content(mediaType = "application/json")),
                        ...
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Not Found - Vendor does not exist")
        })
        public ResponseEntity<ApiResponse<Page<WorkshopTemplateResponse>>> getVendorWorkshopTemplates(
                        @Parameter(description = "Vendor ID", required = true) @PathVariable UUID id,
                        @Parameter(description = "Page number (1-based)", example = "1") @RequestParam(defaultValue = PaginationConstants.DEFAULT_PAGE) int page,
                        @Parameter(description = "Number of items per page", example = "10") @RequestParam(defaultValue = PaginationConstants.DEFAULT_SIZE) int size,
                        @Parameter(description = "Field to sort by", example = "createdAt") @RequestParam(defaultValue = PaginationConstants.DEFAULT_SORT_BY) String sortBy,
                        @Parameter(description = "Sort direction: ASC or DESC", example = "DESC") @RequestParam(defaultValue = PaginationConstants.DEFAULT_SORT_DIR) String sortDir) {
                ...
                Pageable pageable = PageRequest.of(page - 1, size, sort);
                Page<WorkshopTemplateResponse> response = workshopTemplateService.getWorkshopTemplatesByVendorId(id,
                                pageable);
                return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK,
                                "Vendor's workshop templates retrieved successfully", response));
        }

        @GetMapping("/workshop-templates")
        @Operation(summary = "Get all workshop templates with pagination (Admin only)", description = """
        ...
        public ResponseEntity<ApiResponse<Page<WorkshopTemplateResponse>>> getAllWorkshopTemplates(
                ...
                return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK, "Workshop templates retrieved successfully",
                                response));
        }

        @PostMapping("/workshop-templates/{id}/approve")
        @Operation(summary = "Approve a workshop template (Admin only)", description = """
                        ...
                        **After Approval:**
                        ...
                        """)
        @ApiResponses(value = {
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Template approved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = WorkshopTemplateResponse.class))),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Bad Request - Template is not in PENDING status"),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized - Valid JWT token required"),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Forbidden - Admin role required"),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Not Found - Template does not exist")
        })
        public ResponseEntity<ApiResponse<WorkshopTemplateResponse>> approveWorkshopTemplate(
                        @Parameter(description = "Workshop Template ID", required = true) @PathVariable UUID id,
                        Principal principal) {
                WorkshopTemplateResponse response = workshopTemplateService.approveWorkshopTemplate(
                                principal.getName(),
                                id);
                return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK, "Workshop template approved successfully",
                                response));
        }

        @PostMapping("/workshop-templates/{id}/reject")
        @Operation(summary = "Reject a workshop template (Admin only)", description = """
                        ...
                        **Common Rejection Reasons:**
                        ...
                        """)
        @ApiResponses(value = {
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Template rejected successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = WorkshopTemplateResponse.class))),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Bad Request - Template is not in PENDING status or reject reason is missing"),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized - Valid JWT token required"),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Forbidden - Admin role required"),
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Not Found - Template does not exist")
        })
