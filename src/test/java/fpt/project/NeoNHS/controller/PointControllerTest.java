...
//                .longitude(longitude)
//                .type(type)
//                .startTime(LocalDateTime.now(ZoneId.of(TimezoneConstants.ASIA_HO_CHI_MINH)).plusDays(1))
//                .endTime(LocalDateTime.now(ZoneId.of(TimezoneConstants.ASIA_HO_CHI_MINH)).plusDays(1).plusHours(2))
//                .maxParticipants(30)
//                .currentEnrolled(5)
